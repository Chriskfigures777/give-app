...
const STEPS: TypeformStepConfig[] = [
  ...
  },
  {
    ...
    name: "organization",
    type: "text",
    placeholder: "Church or nonprofit name",
  },
  {
    label: "Anything you'd like to share?",
    name: "message",
    type: "textarea",
    placeholder: "What are you hoping to accomplish with Give?",
  },
];
...
export function ContactFormTypeform({
  variant = "standalone",
  onSubmitted,
}: ContactFormTypeformProps) {
      ...
      {!isFooter && (
        <>
          ...
          <p className="mt-3 text-lg text-slate-600">
            Tell us a bit about your organization. We&apos;ll reach out with
            next steps.
          </p>
        </>
      )}
