...
const DASHBOARD_PAGES: DashboardPage[] = [
  ...
  { label: "My gifts", href: "/dashboard/my-donations", keywords: "my gifts donations giving history subscriptions year-end", icon: <Heart className="h-4 w-4" /> },
  { label: "Budget", href: "/dashboard/budget", keywords: "budget tracker spending categories analytics finances", icon: <TableProperties className="h-4 w-4" /> },
  ...
  { label: "Donors", href: "/dashboard/donors", keywords: "donors list givers supporters contributors", icon: <UserRound className="h-4 w-4" /> },
  ...
  { label: "Events", href: "/dashboard/events", keywords: "events calendar fundraising create", icon: <Calendar className="h-4 w-4" /> },
  ...
  { label: "Goals", href: "/dashboard/goals", keywords: "goals 90-day one-year three-year targets progress", icon: <Flag className="h-4 w-4" /> },
  { label: "Priorities", href: "/dashboard/eisenhower", keywords: "priorities eisenhower urgent important whiteboard tasks", icon: <LayoutGrid className="h-4 w-4" /> },
  { label: "People", href: "/dashboard/people", keywords: "people contacts directory list members", icon: <Contact className="h-4 w-4" /> },
  { label: "Givers", href: "/dashboard/givers", keywords: "givers donors supporters missionaries add create", icon: <Users className="h-4 w-4" /> },
  { label: "Messages", href: "/dashboard/messages", keywords: "messages chat threads inbox conversations", icon: <MessageSquare className="h-4 w-4" /> },
  { label: "Notes", href: "/dashboard/notes", keywords: "notes gallery editor bible journal writing", icon: <BookOpen className="h-4 w-4" /> },
  { label: "Surveys", href: "/dashboard/surveys", keywords: "surveys forms builder questions responses results", icon: <ClipboardList className="h-4 w-4" /> },
  { label: "Send message", href: "/dashboard/broadcast", keywords: "broadcast send message email notification blast", icon: <Mail className="h-4 w-4" /> },
  { label: "Donation links", href: "/dashboard/donation-links", keywords: "donation links share payment link", icon: <Link2 className="h-4 w-4" /> },
  ...
  { label: "Customization", href: "/dashboard/customization", keywords: "customization theme branding colors logo donate button split settings", icon: <Paintbrush className="h-4 w-4" /> },
  { label: "Banking", href: "/dashboard/banking", keywords: "banking bank account finances transactions", icon: <Landmark className="h-4 w-4" /> },
  ...
  { label: "Settings", href: "/dashboard/settings", keywords: "settings preferences configuration domain bank account dns splits", icon: <Settings className="h-4 w-4" /> },
