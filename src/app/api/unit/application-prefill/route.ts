...
export async function POST(req: NextRequest) {
  ...
  // JWT subject links the application to the authenticated user (Unit docs: ApplicationFormPrefill)
  // Required for obtaining customer token via JWT exchange
  prefill.jwtSubject = matchedUser.id;
