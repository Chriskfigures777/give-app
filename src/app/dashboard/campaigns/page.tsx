    ...
    <div className="w-full min-w-0 max-w-6xl mx-auto overflow-x-hidden">
      <div className="grid grid-cols-1 gap-6 px-4 py-6">
        <header className="dashboard-fade-in min-w-0">
          <h1 className="text-2xl font-bold tracking-tight text-dashboard-text">Campaigns</h1>
          <p className="mt-1 text-sm text-dashboard-text-muted">
            Create and manage fundraising campaigns. Select a campaign when embedding forms to track progress toward your goal.
          </p>
        </header>
