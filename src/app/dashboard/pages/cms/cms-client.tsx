    ...
    <div className="space-y-4 animate-pulse">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 space-y-2 pt-1">
          <div className="h-5 w-40 rounded bg-dashboard-card-hover" />
          <div className="h-4 w-64 rounded bg-dashboard-card-hover/60" />
        </div>
      </div>
...
/* ── Main CMS Client ──
   Each category fetches its own data independently (streaming: sections appear
   as they arrive rather than waiting for all 6 endpoints to respond).
*/
