  ...
  const plans = [
    {
      ...
      price: "$0",
      period: "/month",
      description: "Full-featured donation platform. Unlimited donations, forms, embeds, QR codes, recurring giving, basic dashboard, tax receipts, theexchangeapp.church subdomain, up to 2 split recipients, connections & chat, Eventbrite integration, feed. No credit card required.",
